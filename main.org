...
(add-hook
 'python-mode-hook
 (lambda()
   (define-key evil-normal-state-local-map (kbd "<SPC> t") 'dy-pytest-one-without-warnings)
   ...
   (define-key evil-normal-state-local-map (kbd "<SPC> =") 'blacken-buffer)
...
(add-hook
 ...
 (lambda()
   ...
   (define-key evil-normal-state-local-map (kbd "<SPC> =") 'lsp-format-buffer)
  ...
  (setq jiralib-token
      (cons "Authorization"
          (concat "Bearer " (auth-source-pick-first-password
              :host "jira.croc.ru"))))
  ;; (jiralib-token "NDk0MjY2MjQwNTM1OvHdVcynoYBNk4wtVojPH9bcY8o0")

  ;; (jiralib-url "https://zyrl.atlassian.net")
  ;; (jiralib-token (cons "Cookie" "cloud.session.token=eyJraWQiOiJzZXNzaW9uLXNlcnZpY2VcL3Byb2QtMTU5Mjg1ODM5NCIsImFsZyI6IlJTMjU2In0..SzvrFOt1iwgXe0vRNh-cSg3T-cGA_aobdRjq8yfJ0I8vXel3vSkyNp-V_EzNd8QVqU0E7Avbdk0nrI18GjZp8WEfNQx6d7MPqLTLWcXa006OGiKTczZk6N9NMsYg7ZtMoqcq1FDezL2v7t0ywv5vCo3zCKHHvIUytdNaHbNq8UuVwP5uffoyRD2eF5OLygKyp1f2uSOmgpdNjRogdbmtGPJG8qaA18vhN_qOixd_QUD2463XoF5JGza5sFp58rGb3FAZGIaoElD0pHwfkavxzQsB8Feb135jmwRVao5ooQJrJ7ygG8cEAGLc95nJ_RuFCkGSNpOaDfovjRomEIY3Sw"))
...
(defun dy-setup-hud-project ()
  ...
  (interactive)
  (progn
    ;; (setenv "CMAKE_PREFIX_PATH" "/usr/lib64/ros:/home/dyens/Qt/6.3.0-static/lib/cmake")
    ;; (setenv "CMAKE_PREFIX_PATH" "/usr/lib64/ros:/home/dyens/Qt/6.2.0/gcc_64/lib/cmake")
    (setenv "CMAKE_PREFIX_PATH" "/usr/lib64/ros:/home/dyens/Qt/6.3.0/gcc_64/lib/cmake")
    ...
    ;; (setenv "ROS_LANG_DISABLE" "")
    (setenv "HUD_DATA_FIXTURES_PATH" "/home/dyens/dev/quantumsoft/fixtures")
    ...
    (setenv "PLANTUML_JAR_PATH" "/home/dyens/dev/quantumsoft/docs/sources")
...
(defun setup-zyrl-project ()
  "Set environment for zyrl project."
  (setq zyrl-github-page "https://github.com/zyrl-sf/z-dash")
  (interactive)
    (defun dy-open-zyrl-in-github-dev()
      (interactive)
      (dy-open-in-github zyrl-github-page 'dev))
    (defun dy-open-zyrl-in-github-rev()
      (interactive)
      (dy-open-in-github zyrl-github-page 'rev))

    (define-key evil-normal-state-map (kbd "<SPC> m b") 'dy-open-zyrl-in-github-dev)
    (define-key evil-normal-state-map (kbd "<SPC> m B") 'dy-open-zyrl-in-github-rev)

    (define-key evil-visual-state-map (kbd "<SPC> m b") 'dy-open-zyrl-in-github-dev)
    (define-key evil-visual-state-map (kbd "<SPC> m B") 'dy-open-zyrl-in-github-rev)
  )
