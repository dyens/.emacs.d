...
(use-package evil
  ...
  ;; Github jump
  (define-key evil-normal-state-map (kbd "<SPC> m b") 'dy-open-in-github-branch)
  (define-key evil-normal-state-map (kbd "<SPC> m B") 'dy-open-in-github-rev)

  (define-key evil-visual-state-map (kbd "<SPC> m b") 'dy-open-in-github-branch)
  (define-key evil-visual-state-map (kbd "<SPC> m B") 'dy-open-in-github-rev)
